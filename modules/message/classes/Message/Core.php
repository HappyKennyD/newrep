...
class Message_Core
{
    ...
    //имена классов переделаны в соответствии с bootstrap
	const ERROR = 'error';      //красный блок
	const NOTICE = 'block';     //желтый блок
	const SUCCESS = 'success';  //зеленый блок
	const WARN = 'warn';        //красный блок
    const INFO = 'info';        //синий блок
