...
class Controller_Manage_Publications extends Controller_Manage_Core {
    ...
    public function action_index()
    {
        ...
        if (!empty($search))
        {
            $this->redirect('manage/publications/'.$type.'/search/'.$search);
        }
    ...
    public function action_edit()
    {
        ...
        if ( $post = $this->request->post() )
        {
            try
            {
                ...
                $public->values($post, array('image','carved_id', 'date', 'is_important', 'slider_position', 'published'));
                ...
                $this->redirect('manage/publications/'.$type.'/view/'.$public->id);
            }
    ...
    */
    ...
    public function action_clearImage()
    {
        ...
        if ($public->loaded())
        {
            ...
            $this->redirect('manage/publications/'.$type.'/edit/'.$id);
        }
        else{
