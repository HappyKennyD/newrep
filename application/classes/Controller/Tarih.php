...
class Controller_Tarih extends Controller_Core {

    public function before()
    {
        parent::before();
        $title=ORM::factory('Specprojecttitle',1)->title;
    ...
    public function action_page()
	{
        ...
        $this->add_cumb(i18n::get('Устная история'),'tarih');
        $this->add_cumb($publication->title,'tarih');
