...
class Controller_Welcome extends Controller_Core
{
    ...
    public function action_index()
    {
        ...
        if (count($publications_slider))
            $publications = ORM::factory('Publication')->where('title_' . I18n::$lang,'<>','')->where('published', '=', 1)->and_where('id', 'NOT IN', $publications_slider)->and_where('is_important', '=', 1)->order_by('date_'.I18n::$lang, 'DESC')->limit(3)->find_all();
        else
            $publications = ORM::factory('Publication')->where('title_' . I18n::$lang,'<>','')->where('published', '=', 1)->and_where('is_important', '=', 1)->order_by('date_'.I18n::$lang, 'DESC')->limit(3)->find_all();
...
//        $biography = ORM::factory('Biography')->where('name_' . I18n::$lang,'<>','')->where('published', '=', 1)->where('era', '=', 1)->and_where('category_id', 'NOT IN', array(3,4,6,7,8,15))->and_where('image', '>', 0)->order_by('is_important', 'DESC')->limit(4)->find_all();
        ...
        $biography = ORM::factory('Biography')->where('name_' . I18n::$lang,'<>','')->where('published', '=', 1)->where('era', '=', 1)->and_where('category_id', 'NOT IN', array(3,4,6,7,8,15))->and_where('image', '>', 0)->and_where('is_important', '=', 1)->order_by('is_important', 'DESC')->find_all();
