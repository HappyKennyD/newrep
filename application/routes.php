...
Route::set('manage-public', '<directory>(/<controller>(/<type>)(/page-<page>)(/<action>(/<id>)))', array('directory' => '(manage)', 'controller' => '(publications|specprojects|publicationprojects)', 'type' => '(publication|news|1|2|3|4|publicationproject)', 'id' => '(\d+)', 'page' => '(\d+)'))
    ->defaults(array(
        'controller' => 'dashboard',
        'action'     => 'index',
        'type'       => 'publication'
...
/* Search in dashboard */
Route::set('manage/search', '<directory>(/<controller>(/<project_id>(/<category>(/<string>))))(/page-<page>)', array('directory' => '(manage)', 'controller' => '(search)','string' => '([^/]+)', 'page' => '(\d+)'))
    ->defaults(array(
        'directory' => 'manage',
        'controller' => 'search',
        'action'     => 'index',
...
/* Add in dashboard */
Route::set('manage/searchadd', '<directory>(/<controller>(/<action>(/<type>(/<project_id>(/<material_id>(/<string>))))))', array('directory' => '(manage)', 'string' => '([^/]+)', 'controller' => '(searchadd)'))
    ->defaults(array(
        'project_id' => '',
        'material_id' => '',
        'directory' => 'manage',
...
// projects
Route::set('project', '<language>/<controller>(/<action>)(/<project_id>)(/<type>)(/<material_id>)(/page-<page>)', array('language' => '(ru|kz|en)', 'controller' => '(project)', 'type' => '(\d+)', 'alpha' => '(\D)', 'page' => '(\d+)'))
    ->defaults(array(
        'controller' => 'project',
        'action'     => '',
        'project_id' => '',
...
//books
Route::set('books', '<language>/<controller>/(/<action>)(/<id>)(/page-<page>)', array('language' => '(ru|kz|en)', 'controller' => '(books)', 'action' => '(index|view|read)', 'page' => '(\d+)', 'id' => '(\d+)'))
    ->defaults(array(
        'controller' => 'books',
        'action'     => 'index',
    ));
...
Route::set('versioned', '(<controller>(/<action>(/<id>)))')
    ->defaults(array(
        'controller' => 'welcome',
        'action'     => 'index'
    ));
